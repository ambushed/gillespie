...
my_gillespieUp = Gillespie(a=species[0],b=species[1],propensities=propensities,increments=incr, nPaths = nPaths,T=T,useSmoothing=True)
bumpUp = my_gillespieUp.run_simulation(*parameters1)
parameters1[idx] = parameters[idx]-delta
my_gillespieDown = Gillespie(a=species[0],b=species[1],propensities=propensities,increments=incr, nPaths = nPaths,T=T,useSmoothing=True)
